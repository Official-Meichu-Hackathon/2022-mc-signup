<template>
  <div class="flex flex-col w-screen mt-16">
    ...
    <div class="grid justify-items-center pt-[8%]">
      ...
      <div class="w-[80%] my-5"> 
        <div class="flex justify-center flex-wrap"> 
          <object data="/line.svg" type="image/svg+xml" class="m-[1%] h-5 sm:h-8 md:h-10 lg:h-14 px-[1rem]" style="pointer-events: none;"></object>
...
.star_move {
  animation: star_bounce 3s infinite;
}
