  ...
  <div class="hidden md:block pop-window">
      ...
      <div class="absolute left-0 right-0 mx-auto grid grid-flow-col flex items-center gap-4 aspect-[738.2/154.5] bottom-0 px-[5%]">
        <!-- <div class="flex justify-between"> -->
          <img :src="companies[selected].img[0]" class="max-w-[3rem] lg:max-w-[5rem] xl:max-w-[7rem]" />
          <img :src="companies[selected].img[0]"  class="max-w-[3rem] lg:lg:max-w-[5rem] xl:max-w-[7rem]" />
        <!-- </div> -->
  ...
  <div class="block md:hidden pop-windowSm">
    <div class="relative aspect-[244/398] bg-[url('../../src/assets/intro_card_sm.svg')] bg-contain bg-no-repeat bg-center z-20">
      ...
      <div class="absolute w-[90%] top-[7%] left-0 right-0 mx-auto aspect-[213/250] overflow-y-auto">
        <p class="card-text pt-5 px-2 text-[2rem] font-bold whitespace-pre-line">
          {{ companies[selected].name }}
        </p>
        <br />
        <p class="card-text pb-5 px-2 text-[1rem] whitespace-pre-line">
          {{ companies[selected].topic }}
          <br /><br />
          {{ companies[selected].intro }}
        </p>
